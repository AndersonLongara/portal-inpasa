...
const ArchitectureSection: React.FC = () => (
   <section className="min-h-screen w-full snap-start flex flex-col items-center justify-center bg-slate-50/50 pb-16 pt-24 px-4 sm:px-8 text-slate-800 relative xl:scale-[0.8] origin-top">
      {/* Cabeçalho do Diagrama */}
      <div className="w-full max-w-[1800px] mb-8 flex flex-col md:flex-row items-start md:items-center justify-between bg-white p-6 rounded-2xl border border-slate-200 shadow-sm gap-4">
        <div>
      ...
      {/* CANVAS DO DIAGRAMA */}
      <div className="w-full max-w-[1800px] bg-white rounded-3xl border border-slate-200 shadow-xl relative">
